...
Legend refs = `bugs/logs/<module>.md`. ❓ = needs verification, ◐ = partial. Cross-module: `<html lang>` = Overview #4, stale-after-switch = Overview #7.
...
`bugs/logs/ui-break-sweep-de.md` for per-module measurements (new IDs CC#6, MGC#3/#4, PC#1/#2, RPT#6, SET#3,
...
(`bugs/logs/ui-break-sweep-es.md`, `bugs/logs/spanish-full-sweep.md`). Result: Spanish is **not** a mild case
...
Detail + CRUD results: `bugs/logs/desktop-1920-de-es-crud.md`.
