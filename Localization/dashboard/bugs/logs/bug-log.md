...
**Compiled:** 2026-07-22 · Every bug is logged in full below. Per-module detail also lives in `<module>.md`.
...
Detail: `all-18-languages.md`. Every language in the production selector has now been opened:
...
Detail: `deep-tier-es-fr-pt-pl-zh.md`
...
Detail: `deep-tier-remaining-10.md`. `ru hu ko vi nl it id or hi fr-CA` now have CRUD + expanded
...
Detail: `f5-f7-f8-attempt.md`. Cut short by a network outage.
...
Detail: `u9-register-glossary-all-languages.md`. Completes U9 (previously de + ar only).
