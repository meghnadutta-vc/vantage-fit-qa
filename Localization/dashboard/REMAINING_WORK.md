...
- [x] ~~**Cold-load re-verification.**~~ **DONE + DOWNGRADED 2026-07-28.** I initially flagged this as the
      ...
      distinction: `bugs/logs/spanish-full-sweep.md`.

**The three P1 leads — ALL NOW EXECUTED 2026-07-28 (Run 11). None is a P1.**
Detail: `bugs/logs/p1-hunt-g5-g6-g4.md`. This closes the biggest credibility gap in the engagement: the
...
strings. Detail: `bugs/logs/ui-break-sweep-es.md` (Run 7) + `bugs/logs/spanish-full-sweep.md` (Run 8).
...
fix the other. Table in `bugs/logs/spanish-full-sweep.md`.
...
Full detail: `bugs/logs/multilang-fr-pt-pl-zh.md`. ~23 surfaces each @1024, dictionary-verified leak
