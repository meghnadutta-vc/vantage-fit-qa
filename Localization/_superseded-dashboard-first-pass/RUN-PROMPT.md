...
> Paste this prompt into Claude Code (or say: *"Read Localization/_superseded-dashboard-first-pass/RUN-PROMPT.md and execute it"*).
...
`Localization/_superseded-dashboard-first-pass/TEST-PLAN.md` (methodology, formatting cheat-sheet) at all times.
...
2. Produce `Localization/_superseded-dashboard-first-pass/SCOPE.md` — a checklist table:
...
- `Localization/_superseded-dashboard-first-pass/SCOPE.md` — updated live as screens complete (✅/⚠️/❌/BLOCKED per cell)
