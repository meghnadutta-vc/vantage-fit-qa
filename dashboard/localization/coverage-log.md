...
| 6 | 2026-07-13 | **Polish — Overview** | pl | Chromium (MCP) | ✅ | pl.json 973/982 translated (0 missing). AC1 PASS, nav fully Polish, no layout breakage, diacritics OK. Only the same language-agnostic wire-up bugs recur (#1,2,3,5,8) — Polish translations exist ("Wszystkie kraje", "Bieżący miesiąc", "NOWOŚĆ") but components render English literals. No new bug IDs. Evidence in evidence/pl/ |
